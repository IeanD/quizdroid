...
class QuestionActivity : AppCompatActivity() {
    ...
    companion object {
        const val TOPIC = "edu.uw.ischool.ieand.QuizDroid.question.TOPIC"
        const val TOPIC_NUM = "edu.uw.ischool.ieand.QuizDroid.question.TOPIC_NUM"
        const val QUESTION_NUM = "edu.uw.ischool.ieand.QuizDroid.question.QUESTION_NUM"
        const val NUM_CORRECT = "edu.uw.ischool.ieand.QuizDroid.question.DESCRIPTION"
        const val NUM_QUESTIONS = "edu.uw.ischool.ieand.QuizDroid.question.NUM_QUESTIONS"
    }
}
